...
public class RoundImageView extends ImageButton {
	 ...
	 * 圆角图片模式
	 */
	public static final int MODE_ROUND_CORNEL = 1;
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		mode = a.getInteger(R.styleable.roundedimageview_pic_cor_mode,
				MODE_CIRCLE);
		edge = a.getDimension(R.styleable.roundedimageview_edge, 0);
	...
	public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
		...
		Rect rect = new Rect(cycle, cycle, scaledSrcBmp.getWidth() - cycle,
				scaledSrcBmp.getHeight() - cycle);
		...
		if (mode == MODE_CIRCLE) {
			...
			canvas.drawRoundRect(rectf, bmpWidth, bmpWidth, paint);
		} else if (mode == MODE_ROUND_CORNEL) {
