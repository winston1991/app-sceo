package com.huntkey.software.sceo.widget.draglistview;
...
//		}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (ev.getAction() == MotionEvent.ACTION_DOWN && !isLock && !isMoving && !isDragItemMoving) {
			...
			// 获取可拖拽的图标
			View draggerIcon = dragger.findViewById(R.id.formedit_item_order);

			// x > dragger.getLeft() - 20这句话为了更好的触摸（-20可以省略）----限制左右可动距离
			if (draggerIcon != null && x > draggerIcon.getLeft() - 20 && x < draggerIcon.getRight() - 20) {
