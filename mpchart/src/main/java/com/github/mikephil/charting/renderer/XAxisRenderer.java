...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderGridLines(Canvas c) {
        ...
        //这里将mAxisLabelModulus改成mAxisGridLineCount
        //若设置了setGridLineCount,则gridline显示条数根据mAxisGridLineCount的大小得到
        //若未设置，gridline显示条数仍由mAxisLabelModulus的大小得到
        for (int i = mMinX; i <= mMaxX; i += mXAxis.mAxisGridLineCount) {
