...
public class MapDevGroupLv2 extends AbstractExpandableItem<MapDevGroupLv3> implements MultiItemEntity {

    public MapDevGroupLv2(String adeg_code, String adeg_name, String adeg_level) {
